...
public class Arena extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Draw stamina bar - updated to pass 'this' component
        bob.drawStaminaBar(g, this);

        // Running indicator - update position to match new stamina bar position
        if (bob.isRunning()) {
            g.setColor(Color.WHITE);
            g.drawString("RUNNING", getWidth() - 80, 82); // Adjusted position
        }
