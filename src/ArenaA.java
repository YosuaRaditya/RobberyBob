...
public class ArenaA extends Arena {
    ...
    public ArenaA(JFrame parentFrame) {
        super(
            "Assets/mapArenaA.jpg", 
            "Assets/collisionArenaA.jpg", 
            120, 370, // Posisi awal RobberyBob di ArenaA
            parentFrame
        );
        cctv = new CCTV(975, 64, 100, 64, "Assets/cctv.png");
        polisi = new Polisi(polisiPatrolPoints[0][0], polisiPatrolPoints[0][1], 100, 64, "Assets/polisiKanan.png");
        ...
        Timer patrolTimer = new Timer(20, e -> {
            ...
            if (dist > polisiSpeed) {
                ...
                if (nextX < targetX) {
                    polisi.setImage("Assets/polisiKiri.png");
                } else if (nextX > targetX) {
                    polisi.setImage("Assets/polisiKanan.png");
                }
